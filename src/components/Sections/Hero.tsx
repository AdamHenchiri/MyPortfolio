...
const Hero: FC = memo(() => {
  const {imageSrc, salut, name, description, actions} = heroData;
    ...
    <Section noPadding sectionId={SectionId.Hero}>
      <div className="relative flex h-screen w-screen items-center justify-center">
        ...
        <div className="z-10  max-w-screen-lg px-4 lg:px-0">
          ...
          <h1 className="text-4xl font-bold text-white sm:text-5xl lg:text-7xl">{salut}</h1>
              ...
              {actions.map(({href, text, primary, Icon}) => (
                <a
                  className={classNames(
                    ...
                    primary ? 'border-gray-700 ring-gray-700' : 'border-white ring-white',
                  )}
                  href={href}
                  key={text}>
                  {text}
